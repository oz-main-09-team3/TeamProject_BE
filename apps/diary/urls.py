...
from apps.diary.views import DiaryView, DiaryCalendarView, DiaryByDateView, CommentView, CommentDeleteView, \
    LikeDeleteView, DiaryImageView, EmotionListView
...
urlpatterns = [
    ...
    path('<int:diary_id>/comments/<int:comment_id>/', CommentDeleteView.as_view()),  # 댓글 삭제
